...
const AboutPage = () => {
  const values = [
    ...
    },
    {
      ...
      title: "Passion",
      description:
        "We are passionate about technology and committed to excellence in everything we do.",
    },
    {
  ...
  const team = [
    {
      ...
      avatar:
        "https://images.pexels.com/photos/3785077/pexels-photo-3785077.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&dpr=2",
    ...
    },
    {
      ...
      avatar:
        "https://images.pexels.com/photos/3756679/pexels-photo-3756679.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&dpr=2",
    ...
    },
    {
      ...
      role: "Head of Design",
      avatar:
        "https://images.pexels.com/photos/3777931/pexels-photo-3777931.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&dpr=2",
    ...
    },
    {
      ...
      role: "Head of Sales",
      avatar:
        "https://images.pexels.com/photos/2379005/pexels-photo-2379005.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&dpr=2",
  ...
  const milestones = [
    {
      ...
      description:
        "eplanor was born from a vision to democratize cutting-edge technology.",
    },
    {
      year: "2017",
      title: "First Major Client",
      description:
        "Secured our first enterprise client and delivered transformational results.",
    },
    {
      year: "2019",
      title: "Global Expansion",
      description:
        "Opened offices in Europe and Asia to serve clients worldwide.",
    },
    {
      year: "2021",
      title: "AI Innovation Lab",
      description:
        "Launched dedicated AI research division to pioneer next-gen solutions.",
    },
    {
      year: "2023",
      title: "500+ Projects",
      description:
        "Celebrated delivering over 500 successful projects across industries.",
    },
    {
      year: "2024",
      title: "Industry Recognition",
      description:
        'Named "Tech Innovator of the Year" by leading industry publications.',
    },
  ];

  const stats = [
    { number: 1, label: "Years of Excellence" },
    { number: 37, suffix: "+", label: "Projects Completed" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8">
                At eplanor, we're not just building software – we're crafting
                the digital experiences that will define tomorrow. Our team of
                visionaries, engineers, and innovators work tirelessly to
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/contact">
                  <Button
                    variant="outline"
                    className="border-white text-black rounded-2xl px-8 py-3 hover:bg-white hover:text-[#0A192F]"
                  >
                    Get In Touch
                  </Button>
                </Link>
            ...
            >
              <div className="relative z-10">
                <img
                  ...
                  alt="eplanor team collaboration"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                To democratize access to cutting-edge technology and empower
                businesses to achieve their full potential through innovative
                digital solutions. We believe that every organization,
                regardless of size, should have access to enterprise-grade
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                ...
                a world where technology serves humanity and enables businesses
                to make a positive impact. We envision a future where innovation
                knows no boundaries and every idea has the potential to change
                the world.
              </p>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              These values guide every decision we make and shape the culture
      ...
      <section className="py-24 gradient-bg text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            incredible team, we'd love to hear from you.
          </motion.p>
          <motion.div
