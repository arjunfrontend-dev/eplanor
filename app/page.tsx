...
const HomePage = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        "Bank-level security protocols to protect your most valuable assets.",
    },
    {
      icon: <Target className="w-8 h-8" />,
      title: "Precision Engineering",
      description:
        "Every solution crafted with meticulous attention to detail and performance.",
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Lightning Fast",
      description:
        "Optimized for speed and performance at every level of your stack.",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "eplanor transformed our entire tech infrastructure. The results exceeded our expectations.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      ...
      content:
        "Working with eplanor was the best decision we made. Their expertise is unmatched.",
      rating: 5,
    },
    {
      ...
      content:
        "The level of innovation and technical excellence eplanor brings is incredible.",
      rating: 5,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We combine innovation, security, and performance to deliver
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover our most popular solutions that are transforming
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Professional services designed to accelerate your digital
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              A proven methodology that ensures success from concept to
              deployment.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "We analyze your needs and develop a comprehensive strategy.",
              },
              {
                step: "02",
                title: "Design & Develop",
                description:
                  "Our team creates innovative solutions tailored to your goals.",
              },
              {
                step: "03",
                title: "Deploy & Scale",
                description:
                  "We launch your solution and help you scale for growth.",
              },
            ].map((item, index) => (
              <motion.div
                key={item.step}
