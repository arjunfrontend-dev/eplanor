...
const CareersPage = () => {
  const openPositions = [
    ...
    },
    {
      ...
      salary: "$140k - $200k",
      description:
        "Lead the development of machine learning models and AI-powered solutions for our enterprise clients.",
      requirements: [
        "PhD/Masters in ML/AI",
        "Python/TensorFlow",
    ...
    },
    {
      ...
      salary: "$90k - $140k",
      description:
        "Create exceptional user experiences and beautiful interfaces for our digital products.",
      requirements: [
    ...
    },
    {
      ...
      salary: "$130k - $180k",
      description:
        "Drive product strategy and roadmap for our enterprise SaaS platform.",
      requirements: [
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "$5,000 annual learning budget and access to premium courses.",
    },
    {
      icon: <DollarSign className="w-8 h-8" />,
      title: "Competitive Compensation",
      description:
        "Top-tier salaries, equity packages, and performance bonuses.",
    },
    {
      icon: <Building className="w-8 h-8" />,
      title: "Modern Equipment",
      description:
        "Latest MacBook Pro, monitor setup, and premium software tools.",
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Team Events",
      description:
        "Regular team building activities, retreats, and social events.",
    },
  ];
  ...
  const culture = [
    {
      ...
      quote:
        "Working at eplanor feels like being part of a close-knit family where everyone supports each other.",
    },
    {
      image:
      ...
      quote:
        "We encourage experimentation and give everyone the freedom to pursue innovative ideas.",
    },
    {
      image:
        "https://images.pexels.com/photos/3184394/pexels-photo-3184394.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=2",
      title: "Work-Life Balance",
      quote:
        "eplanor truly values work-life balance, making it possible to excel professionally while enjoying life.",
    },
  ];
    ...
    <div className="pt-16">
      ...
      <section className="relative navy-bg text-white py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Build the future of technology with talented individuals who share
          ...
          >
            ...
            <Button
              variant="outline"
              className="border-white text-black rounded-2xl px-8 py-3 text-lg hover:bg-white hover:text-[#0A192F]"
            >
              Learn About Culture
            </Button>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Join our talented team and help us build the next generation of
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Hear from our team members about what makes eplanor a great place
              to work.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              A transparent and fair process designed to find the right fit for
            ...
            {[
              {
                ...
                title: "Application",
                description:
                  "Submit your application and tell us why you're excited about eplanor.",
              },
              {
                step: "2",
                title: "Screen Call",
                description:
                  "Initial conversation with our HR team to discuss your background and interests.",
              },
              {
                step: "3",
                title: "Technical Interview",
                description:
                  "Deep dive into your technical skills and problem-solving approach.",
              },
              {
                step: "4",
                title: "Team Meet",
                description:
                  "Meet with potential teammates and learn more about our culture.",
              },
            ].map((step, index) => (
              <motion.div
                key={step.step}
